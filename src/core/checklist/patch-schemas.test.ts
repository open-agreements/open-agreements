...
describe('ChecklistPatch schemas', () => {
  ...
  it('enforces citation value shape for citation paths', async () => {
  ...
  it('allows patch citation with text only', async () => {
    const parsed = await safeParseWithEvidence(
  ...
  it('requires validation_id for apply requests', async () => {
