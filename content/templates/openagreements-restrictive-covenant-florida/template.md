---
template_id: openagreements-restrictive-covenant-florida
layout_id: cover-standard-signature-v1
style_id: openagreements-default-v1
outputs:
  docx: content/templates/openagreements-restrictive-covenant-florida/template.docx
document:
...
| row | Operating / Service-Recipient Affiliate | {employer_operating_affiliate_name} | employer_operating_affiliate_name |
...
[[Covered Customers]] means customers, patients, clients, vendors, referral sources, and business partners with whom Employee had material contact or for whom Employee had responsibility during the {covered_customer_period} before termination of employment.
...
<!-- oa:clause id=recitals-and-legitimate-business-interest -->
...
<!-- oa:clause id=choice-act-counsel-notice confirm=choice_act_advance_notice_confirmed confirm_note="the written right-to-counsel advisal and at least 7-day advance notice were actually given before signing" authority_url="https://www.flsenate.gov/Laws/Statutes/2025/542.45" -->
...
<!-- oa:clause id=enforceability-severability-and-reformation -->
