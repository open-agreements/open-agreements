...
describe('ExternalMetadataSchema', () => {
  ...
  itDiscovery('rejects missing source_sha256', async () => {
    const input = {
      name: 'Test SAFE',
      source_url: 'https://example.com/safe',
      version: '1.0',
...
describe('External fill end-to-end', () => {
  itFilling('fills yc-safe-valuation-cap with sample values', async () => {
...
describe('list includes external templates', () => {
  itDiscovery('list --json includes yc-safe templates', async () => {
