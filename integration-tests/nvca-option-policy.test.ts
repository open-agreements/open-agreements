...
describe('NVCA option resolution policy', () => {
  it('costs-of-enforcement policy keeps only the each-party clause', async () => {
  ...
  it('preserves unresolved in-line legal alternatives until an explicit clause policy is added', async () => {
