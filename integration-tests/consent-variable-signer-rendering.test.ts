...
const BOARD_TEMPLATE_DIR = slugDir(REPO_ROOT, 'openagreements-board-consent-safe');
const STOCKHOLDER_TEMPLATE_DIR = slugDir(REPO_ROOT, 'openagreements-stockholder-consent-safe');
