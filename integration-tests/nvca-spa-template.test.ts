...
const FIELD_ASSERTION_POLICY: Record<string, FieldAssertionPolicy> = {
  ...
  purchaser_is_plural: { mode: 'skip', reason: 'Computed control input; drives purchaser_scope token' },
  purchaser_scope: { mode: 'strict', reason: 'Singular/plural scope word derived from purchaser_is_plural' },
