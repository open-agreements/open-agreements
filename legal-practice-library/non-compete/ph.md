...
description: >-
  The Philippines has no non-compete statute; a post-employment restraint is
  enforceable only if it is reasonable — limited as to time, trade, and place,
  tied to a legitimate business interest, and not contrary to public policy —
  and a suit to enforce one is a civil case for the regular courts, not the
  labor tribunals.
