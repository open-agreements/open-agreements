...
description: >-
  ...
  the five-factor reasonableness test, the N.C. Gen. Stat. § 75-4 writing
  requirement, the new-consideration rule for mid-employment covenants,
  time-and-territory limits, the strict blue-pencil doctrine that bars judicial
  reformation, non-solicitation drafting, tolling and extension-on-breach
  clauses, physician public-policy limits, the § 22B-3 forum-clause bar,
  attorney-fee recovery, trade-secret alternatives, and the pending HB 269 and
  SB 673 bills.
