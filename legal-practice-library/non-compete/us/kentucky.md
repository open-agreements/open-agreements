...
description: >-
  Kentucky enforces non-competes only when the restraint is reasonable under
  common law and supported by valid consideration, with a narrow statutory ban
  for temporary health care staffing.
