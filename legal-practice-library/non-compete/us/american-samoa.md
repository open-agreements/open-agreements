...
description: >-
  American Samoa has no non-compete statute and no on-point case law found in
  our review; its High Court would gap-fill through the imported common law of
  A.S.C.A. § 1.0201 and the Restatement reasonableness test, while local public
  policy and a tiny island economy make aggressive covenants hard to enforce.
