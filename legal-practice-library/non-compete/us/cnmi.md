...
description: >-
  The CNMI has no non-compete statute; post-employment covenants are enforceable
  only if they are reasonable under Restatement (Second) of Contracts § 188,
  which the rules-of-decision statute 7 CMC § 3401 imports as Commonwealth law,
  and the one on-point decision denied a preliminary injunction against two
  former medical-transport employees on Saipan.
