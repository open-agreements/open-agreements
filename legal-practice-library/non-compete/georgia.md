...
description: >-
  A question-by-question summary of Georgia non-compete law under the Georgia
  Restrictive Covenants Act (O.C.G.A. §§ 13-8-50 to 13-8-59), covering the
  reasonableness standard, the employee-category limits, the two-, three-, and
  five-year durational presumptions, implied geographic scope after Wimmer,
  customer and employee non-solicitation covenants, material contact, judicial
  modification (blue-pencil), choice-of-law limits under Motorsports of Conyers,
  tolling and the no-equitable-extension rule of Daneshgari, confidentiality and
  trade-secret alternatives, physician covenants, and the May 11, 2011 effective
  date.
