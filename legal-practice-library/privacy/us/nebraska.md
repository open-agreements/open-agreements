...
description: >-
  The Nebraska Data Privacy Act gives Nebraska consumers rights over their
  personal data and imposes notice, contracting, and consent duties on most
  for-profit businesses — unusually, it uses no consumer-volume or revenue
  threshold and instead exempts only federal small businesses, and it is
  enforced exclusively by the Attorney General with a 30-day cure period and no
  private right of action.
resource: 'https://openagreements.org/practice-guides/privacy/us/nebraska'
