...
description: >-
  The New Jersey Data Privacy Act gives New Jersey consumers rights over their
  personal data and imposes notice, contracting, and consent duties on
  controllers above defined thresholds — it is enforced exclusively by the
  Attorney General as an unlawful practice under the Consumer Fraud Act, with no
  private right of action and only a temporary right to cure.
resource: 'https://openagreements.org/practice-guides/privacy/us/new-jersey'
