...
| 技能 | 描述 |
|-------|-------------|
| [open-agreements](https://github.com/open-agreements/open-agreements/tree/main/skills/agreements/open-agreements) | 填写标准法律协议模板（NDA、云服务协议、SAFE）并生成可签署的 DOCX 文件。支持 Common Paper、Bonterms 和 Y Combinator 模板。在用户需要起草法律协议、生成 NDA、填写合同模板或生成 SAFE 时使用。 |
