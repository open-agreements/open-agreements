...
title: Describe third party recipients — example phrasings
description: >-
  Real-world privacy-policy phrasings labeled by the detector for
  REQ-privacy-law.privacy-policy.describe-third-party-recipients, mined from the
  public Fortune 500 corpus.
resource: 'https://openagreements.org/practice-guides/privacy/us#what-the-policy-must-say'
tags:
  - privacy-policy
  - describe-third-party-recipients
  - exemplar-gallery
---

# Describe third party recipients — example phrasings

Phrasing library for [REQ-privacy-law.privacy-policy.describe-third-party-recipients](https://openagreements.org/practice-guides/privacy/us#what-the-policy-must-say). 12 conforming exemplar(s) plus contrast cases, mined from the public privacy-policy corpus and labeled by the detector. Each excerpt is the span the detector matched, quoted verbatim from the source policy (whitespace normalized) where the original text could be recovered (#758), otherwise the detector's normalized span.
...
> How we may disclose Personal Data We generally share personal information with third parties for the business and commercial purposes described below.
...
- conformance: non-conforming
- source: [Diamondback Energy](https://ir.diamondbackenergy.com/site-info/privacy-policy)
- detected_by: A only; no action
- captured: 2026-06-26T18:10:32.587Z
- link_to_source: <https://ir.diamondbackenergy.com/site-info/privacy-policy>
