---
type: Law Topic
title: Sell-Side Transaction Readiness for Small and Lower-Middle-Market Businesses
description: >-
  A seller-side practice note for organizing business records, identifying
  issues before a sale process, considering possible remediation, and preparing
  materials for buyer and counsel review.
resource: 'https://openagreements.org/practice-guides/sell-side-transaction-readiness/us'
