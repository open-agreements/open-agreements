...
title: Non-Competes in the U.S. Virgin Islands
description: >-
  The U.S. Virgin Islands may enforce a reasonable non-compete but has no
  statute on point; the Superior Court in Arvidson v. Buchar judges covenants
  under an indigenous common-law reasonableness test selected through the Banks
  methodology, and a small-island economy plus a no-at-will Wrongful Discharge
  Act make aggressive restraints hard to enforce.
