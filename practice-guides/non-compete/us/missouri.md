...
title: Non-Competes in Missouri
description: >-
  Missouri enforces non-competes only when the restraint is reasonable and tied
  to protecting trade secrets or customer contacts, with separate statutory safe
  harbors for non-solicitation and owner covenants.
