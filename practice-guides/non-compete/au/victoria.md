...
description: >-
  In Victoria a post-employment non-compete is presumptively void as a restraint
  of trade and binds a former employee only so far as it is reasonable; Victoria
  has no statutory read-down power, so courts apply the common-law blue-pencil
  rule only — they can delete severable words but cannot rewrite an overbroad
  clause, and as Just Group v Peck shows, even an elaborately drafted restraint
  can fail because severance is not a safety net.
