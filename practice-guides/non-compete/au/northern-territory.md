...
description: >-
  In the Northern Territory a post-employment non-compete is presumptively void
  as a restraint of trade and binds a former employee only so far as it is
  reasonable; the Territory has no statutory read-down power, and in the leading
  Supreme Court employment case an eighteen-month restraint failed entirely
  because it was longer than necessary, even though the court considered fifteen
  months at most would have been reasonable.
resource: 'https://openagreements.org/practice-guides/non-compete/au/northern-territory'
