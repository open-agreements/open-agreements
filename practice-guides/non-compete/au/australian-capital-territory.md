...
description: >-
  In the Australian Capital Territory a post-employment non-compete is
  enforceable only so far as it is reasonable to protect a legitimate business
  interest; the Territory has no statutory read-down power, so a court cannot
  rewrite an overbroad clause — in the Territory's leading case a 24-month
  restraint on a general manager was upheld while a parallel restraint failed
  entirely because an overbroad defined term could not be severed or read down.
resource: >-
