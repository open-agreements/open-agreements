...
description: >-
  Mississippi has no employee-invention-assignment statute and no Mississippi
  appellate decision found in our review construes such a clause on the merits,
  so an assignment clause is bounded only by ordinary contract law, the
  common-law default rules, and the federal patent and copyright overlay — not a
  California-style own-time carve-out or notice requirement. Absent a written
  assignment the inventor owns unless hired to invent, and the enforceability of
  a post-employment holdover clause is unsettled — no Mississippi authority
  found in our review, and even the covenant-reasonableness analogy from Redd
  Pest Control v. Heatherly is untested for invention holdovers.
resource: 'https://openagreements.org/practice-guides/invention-assignment/us/mississippi'
