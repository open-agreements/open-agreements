...
description: >-
  Oregon has no employee-invention-assignment statute, so an assignment clause
  ...
  to invent, subject to the employer's shop right; Oregon's noncompete statute
  does not reach assignment clauses, and the Oregon Court of Appeals has said in
  dicta that an employer may capture inventions conceived during employment and
  for a reasonable period after termination, so a holdover clause would be
  judged under Oregon's common-law reasonableness rule for partial restraints.
