...
title: Employee Invention Assignment in Puerto Rico
description: >-
  Puerto Rico — a civil-law jurisdiction governed by the Civil Code of 2020 —
  has no private-sector employee-invention statute, so an assignment clause is
  an ordinary Civil Code contract bounded by the federal patent overlay, not a
  California-style own-time carve-out or notice requirement. The only Puerto
  Rico employee-invention statute, 3 L.P.R.A. § 694a, covers Commonwealth
  research personnel only. Absent a written assignment the federal
  inventor-first default leaves ownership with the employee, and whether a
  post-employment holdover clause would face the strict Arthur Young non-compete
  doctrine or be treated as an ordinary title-allocation clause is unsettled.
resource: 'https://openagreements.org/practice-guides/invention-assignment/us/puerto-rico'
