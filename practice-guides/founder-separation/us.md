...
[^about]: By Steven Obiajulu, J.D. Published by [openagreements.org](https://openagreements.org). Last reviewed 2026-07-01. License: CC BY 4.0. Steven Obiajulu, J.D. edits this topic article for Delaware (DGCL) coverage. It synthesizes legal sources and is not legal advice. This article is for informational purposes only and does not create an attorney-client relationship. Source excerpts and linked materials belong to their owners. CC BY 4.0. Cite as Steven Obiajulu, *Founder Separation and Stock Repurchase: How to Cleanly Document a Founder's Departure from a Delaware Startup*, OpenAgreements (last updated July 1, 2026), https://openagreements.org/practice-guides/founder-separation/us.
