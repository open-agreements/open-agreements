...
description: >-
  The Rhode Island Data Transparency and Privacy Protection Act, effective
  January 1, 2026, sets information-sharing-practices disclosure duties for
  commercial websites and broader controller obligations — sensitive-data
  consent and processor contracts — on for-profit entities above defined
  customer thresholds, enforced exclusively by the Attorney General with no
  private right of action.
resource: 'https://openagreements.org/practice-guides/privacy/us/rhode-island'
