...
description: >-
  The Kentucky Consumer Data Protection Act, effective January 1, 2026, gives
  Kentucky consumers rights over their personal data and imposes notice,
  contracting, and consent duties on controllers above defined thresholds —
  closely modeled on Virginia, it is enforced exclusively by the Attorney
  General with a permanent 30-day cure period and provides no private right of
  action.
resource: 'https://openagreements.org/practice-guides/privacy/us/kentucky'
