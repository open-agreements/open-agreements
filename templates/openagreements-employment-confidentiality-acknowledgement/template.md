...
| **Approved Tools Scope** | {approved_tools_scope} |
| **Data Access Scope** | {data_access_scope} |
| **Security Reporting Contact** | {security_reporting_contact} |
| **Post-Employment Obligations** | {post_employment_obligations} |
| **Acknowledgement Date** | {acknowledgement_date} |
