...
Match the operative verb to the conduct you want to reach. If you intend to bar hiring as well as solicitation, say so expressly, because a covenant limited to _solicit, recruit, or induce_ requires active persuasion and will not reach a passive hire; and confine customer non-solicits to actual, not prospective, customers .
