...
outputs:
  docx: templates/openagreements-cc-by-4.0/openagreements-stockholder-consent-safe/template.docx
document:
...
<!-- oa:signer id=stockholder kind=individual capacity=personal label="Stockholder" -->
Signature: _______________
Print Name: {stockholder.name}
Date: {effective_date}
