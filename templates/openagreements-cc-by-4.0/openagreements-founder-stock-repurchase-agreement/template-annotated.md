...
Founder
: [Full name of the founder whose shares are being repurchased]
...
Shares Repurchased
: [Description of the shares repurchased (for example, "500,000 shares of Common Stock")]

Price per Share
: [Repurchase price per share (for example, "$0.0001")]

Aggregate Price
: [Aggregate repurchase price for all repurchased shares]

Consideration
: [Form of consideration paid for the shares (for example, "cash" or "cancellation of the promissory note dated January 1, 2022")]

Closing Date
: [Date the repurchase and cancellation close]

Release Scope
: [Description of the scope of the mutual release (used when include_mutual_release is true)]
