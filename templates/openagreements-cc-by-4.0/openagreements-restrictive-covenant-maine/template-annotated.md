...
### drafting to the restraint actually intended

Do not draft broadly just because Maine recognizes as-applied review. _Lord_ still requires a record showing that the scope is reasonably necessary to protect the specific goodwill or business value at issue .

### confidentiality alternative and its ceiling

Do not make a confidentiality clause do non-compete work. Maine allows protection for specialized confidential information, but _Bernier_ distinguishes that from blocking general skill and knowledge .
