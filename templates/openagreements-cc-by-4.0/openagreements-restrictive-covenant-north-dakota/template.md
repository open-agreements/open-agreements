...
[[Covered Employees]] means only those employees of Employer with whom Employee worked, or whom Employee supervised or managed, during the {covered_employee_period} before termination of employment. This defined class is deliberately bounded to colleagues Employee actually worked with and does not extend to Employer's workforce generally.
