...
Each covenant is supported by and no broader than necessary to protect Employer's Protected Interests. In consideration for this agreement, Employer provides Employee with {additional_consideration}.
...
During the Restricted Period, Employee must not engage in, be employed by, consult for, or have an active ownership interest in any Competitive Business within the Restricted Territory. Employee's covered function is: {covered_employee_function}. Passive Public Holdings are permitted.
