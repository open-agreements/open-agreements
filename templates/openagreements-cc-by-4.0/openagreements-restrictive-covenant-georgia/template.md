...
[[Covered Customers]] means customers and prospective customers with whom Employee had material contact during the {covered_customer_period} before termination of employment, meaning customers Employee dealt with on Employer's behalf, whose dealings with Employer Employee coordinated or supervised, about whom Employee obtained confidential information in the ordinary course of business, or from whom Employee earned compensation, commissions, or earnings, consistent with O.C.G.A. § 13-8-51(10).
...
During the Restricted Period, Employee must not engage in, be employed by, consult for, or have an active ownership interest in any Competitive Business within the Restricted Territory. This covenant applies only because Employee performs a covered function under O.C.G.A. § 13-8-53(a) — Employee customarily and regularly solicits customers or prospective customers, makes sales or obtains orders or contracts, performs the enumerated managerial duties, or serves as a key employee or a professional — as recorded in Cover Terms and the recitals. Employee's covered function is: {covered_employee_function}. The covenant contains limitations as to time, geographic area, and scope of prohibited activities that the parties intend to be reasonable and impose no greater restraint than necessary to protect Employer's Protected Interests, as O.C.G.A. § 13-8-53(a) requires. Where the Restricted Territory tracks the areas in which Employer conducts business, or names particular competitors for a limited period, the parties intend it to fall within the geographic-reasonableness presumption of O.C.G.A. § 13-8-56(2). Passive Public Holdings are permitted.
