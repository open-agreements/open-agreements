...
: the geographic areas in which Employer conducts business

Competitive Business
: [Description of the business activities that constitute competition with the employer.]

Specified Competitors
: [Optional named list of specific competitors. Naming competitors for a limited period is one route by which an employer's-business-areas territory earns the presumption of geographic reasonableness.]
...
Do not assume a Georgia covenant fails for lack of an express territory, and do not assume one with a territory is automatically safe. After _Wimmer_, geographic scope is judged for overall reasonableness under O.C.G.A. § 13-8-56, so an unreasonably broad express territory is still vulnerable .
...
Do not draft an overbroad covenant on the assumption a Georgia court will rewrite it into shape. Modification under O.C.G.A. § 13-8-53(d) is discretionary and can only narrow, not expand — and in _Belt Power v. Reed_ the court declined to modify at all .
