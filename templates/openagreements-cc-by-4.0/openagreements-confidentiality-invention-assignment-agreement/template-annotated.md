...
: For as long as the information remains confidential, and, where applicable law requires a fixed period, two years after employment ends
...
Drafting and enforceability considerations for this template, from the related practice guide: [Employee Invention Assignment in Kansas](/practice-guides/invention-assignment/us/kansas).

### Kansas notice wording tracks K.S.A. 44-130's own text

Kansas conditions the assignment provision on a written notification given at the time the agreement is made, and its notice subsection words the business-relation exception more narrowly than the California formulation most multistate notices track: an own-time invention falls back into the assignable scope only when it relates _directly_ to the employer's business or actual or demonstrably anticipated research or development . A notification that states only the broader California-style _relates to_ exception overstates the employer's reach for a Kansas employee, and K.S.A. 44-130(b) makes an assignment provision void and against Kansas public policy to the extent it purports to capture what the statute protects — so a Kansas-compliant notice keeps the _relates directly_ limitation in its own text .
