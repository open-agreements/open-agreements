...
**WHEREAS**, the Founder's written resignation is effective on the date and at the time specified in that resignation.
...
The Board approves the disposition identified as {share_disposition} pursuant to the corresponding resolution below.
...
The Board approves the action identified as {vacancy_action} pursuant to the corresponding resolution below.

*Option A — Reduce the authorized number of directors.* **RESOLVED**, that, to reflect the departure of the Founder, the authorized number of directors of the Company be, and it hereby is, reduced to {board_size_after}, effective as of the date of these resolutions; provided that any amendment to the Company's certificate of incorporation required to effect the reduction has become effective.
