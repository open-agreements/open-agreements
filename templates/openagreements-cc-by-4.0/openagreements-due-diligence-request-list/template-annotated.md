...
**CONFIDENTIAL.** This request list and the parties' related discussions are confidential and subject to the parties' executed confidentiality agreement. The thresholds and lookback periods that govern the requests are set out in the Engagement Scope and Instructions below.

Requesting Firm
: [Legal name of the buyer's law firm sending the request]

Target Company
: [Legal name of the target company receiving the request]

Project Code Name
: [Project code name or pseudonym used to refer to the transaction]

Request Date
: [Date the request list is delivered to the target]

Response Due Date
: [Date by which the target's first-round response is due]

Lead Buyer Counsel
: [Name of the lead attorney at the requesting firm]

Lead Buyer Counsel Email
: [Email of the lead attorney at the requesting firm]

Primary Target Contact
: [Name of the target's primary point of contact for diligence responses]
...
**Materiality.** Where a request is qualified by "material," "material" means the lower of (a) $100,000 per item or annual aggregate, or (b) 5% of the target's gross revenue for the most recent completed fiscal year, with all dollar amounts stated in USD. The materiality qualifier is dollar-based unless the request specifies otherwise. Qualitative materiality (anti-assignment, change-of-control, exclusivity, MFN, IP encumbrance) governs regardless of the dollar threshold.

**Lookback.** Unless a section specifies otherwise, the lookback period is 3 years. Tax returns are requested for the past 6 years (Section D). Regulatory investigations, settlements, and consent decrees should be produced regardless of date.
...
A.3 Complete minute books for the past 3 years, including board minutes, written consents, and committee minutes.

A.4 Stockholder or member meeting minutes and written consents for the past 3 years.
...
A.6 Officer and director list, including titles, dates of service, and any departures within the past 3 years.
...
B.5 409A valuation reports for the past 3 years.
...
D.2 Federal tax returns for the past 6 years.
...
F.1 All contracts with annual revenue or expenditure exceeding $100,000 or 5% of gross revenue.
...
I.4 Cybersecurity-incident history for the past 3 years, including breach notifications to regulators, customers, or employees.
...
J.3 All employee benefit plans, including 401(k), health, welfare, severance, and any defined-benefit plans, with IRS Form 5500 filings for the past 3 years.
...
K.1 Schedule of all pending and threatened claims, lawsuits, administrative proceedings, arbitrations, and investigations within the past 3 years. Include the parties, forum, claim summary, status, and amount in controversy.
...
K.5 Audit response letters from the target's outside counsel for the past 3 years.
...
L.2 Routine regulatory filings and compliance certifications for the past 3 years.
...
M.2 Claims history for the past 3 years for each policy type.
