...
Drafting and enforceability considerations for this template, from the related practice guide: [Non-Competes in New Jersey](/practice-guides/non-compete/us/new-jersey).

### reasonableness

Do not assume the New Jersey consideration rule excuses an unreasonable restraint. Continued employment can support the covenant, but the restraint itself must still pass the _Solari/Whitmyer_ reasonableness test on duration, territory, and scope .
