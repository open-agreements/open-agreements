...
: {minimum_qualifying_compensation}

Medical Specialist Minimum Compensation
: {medical_specialist_threshold}
...
[[Covered Employees]] means employees with whom Employee worked or whom Employee managed during the {covered_employee_period} before termination of employment. This defined contract term is distinct from the statutory term "covered employee" in D.C. Code § 32-581.01(6), which refers to a worker the non-compete ban protects.
