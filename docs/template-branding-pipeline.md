...
- A `template.md` with canonical YAML frontmatter (containing `template_id`,
  ...
  generated JSON spec is written to `templates/<source>-<rights>/<slug>/.template.generated.json`
...
- canonical sources: `templates/<source>-<rights>/<slug>/template.md` (YAML frontmatter + Markdown body)
- generated specs: `templates/<source>-<rights>/<slug>/.template.generated.json` (auto-written)
- hand-authored specs: `templates/<source>-<rights>/<slug>/template.json` (legacy; new templates should be canonical)
...
1. Create `templates/<source>-<rights>/<your-slug>/template.md` with YAML frontmatter:
   ...
   - `outputs.docx`: path to the rendered DOCX (typically `templates/<source>-<rights>/<slug>/template.docx`)
