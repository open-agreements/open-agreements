...
| Cooley GO forms | Proprietary terms | `restricted-no-automation` | Excluded | Not onboarded for automated fetch/field-selector/vendoring |

## Enforcement Notes

- `restricted-no-automation` sources are excluded from scripted ingestion,
  field-selector auto-download, and in-repo vendoring.
